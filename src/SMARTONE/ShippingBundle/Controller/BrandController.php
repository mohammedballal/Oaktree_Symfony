...
use SMARTONE\ShippingBundle\Entity\Brand;
use SMARTONE\ShippingBundle\Form\BrandType;
...
class BrandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SMARTONEShippingBundle:Brand')->findAll();
     ...
     * @Method("POST")
     * @Template("SMARTONEShippingBundle:Brand:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SMARTONEShippingBundle:Brand')->find($id);
