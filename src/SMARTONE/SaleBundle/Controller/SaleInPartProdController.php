 ...
 * @Route("/sale/part")
 */
class SaleInPartProdController extends Controller
{
     ...
     *
     * @Route("/{id}/edit", name="sale_in_part")
     * @Method("GET")
     */
    ...
    */
    private function createEditForm(Sale $entity)
    {
        $form = $this->createForm(new SaleInStageType(), $entity, array(
            'action' => $this->generateUrl('sale_in_part_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="sale_in_part_update")
     * @Method("PUT")
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($form->isValid()) {
            $entity->setPartProduction(true);
            $entity->setFullProduction(false);
