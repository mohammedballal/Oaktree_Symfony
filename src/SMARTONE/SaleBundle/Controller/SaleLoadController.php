...
class SaleLoadController extends Controller
{
    ...
    */
    ...
    {
        $form = $this->createForm(new SaleLoadStageType(), $entity, array(
            'action' => $this->generateUrl('sale_load_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="sale_load_update")
     * @Method("PUT")
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($form->isValid()) {
            ...
            $entity->setLoadedDate(new \DateTime());
            $em->flush();
